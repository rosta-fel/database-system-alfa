namespace DatabaseSystemAlfa.Libraries.Tools.Console.Message
{
    ...
    public class MessageTemplate(string message) : MessageBase(message)
    {
        ...
        public static MessageTemplate Regular(string message) => new MessageTemplate(message);
        ...
        public static MessageTemplate Info(string message) => new MessageTemplate($"[cyan]INFO[/]: [gray]{message}[/]");
        ...
        public static MessageTemplate Success(string message) => new MessageTemplate($"[green]{message}[/]");
        ...
        public static MessageTemplate Warning(string message) => new MessageTemplate($"[yellow]WARN[/]: [gray]{message}[/]");
        ...
        public static MessageTemplate Error(string message) => new MessageTemplate($"[red]ERROR[/]: [gray]{message}[/]");
        ...
        public static MessageTemplate Tip(string message) => new MessageTemplate($"[blue]TIP[/]: [gray]{message}[/]");
        ...
        public static MessageTemplate Bold(string message) => new MessageTemplate($"[bold]{message}[/]");
        ...
        public static MessageTemplate Italic(string message) => new MessageTemplate($"[italic]{message}[/]");
        ...
        public static MessageTemplate HighlightArg(string promptMsg, string promptArg)
            => new MessageTemplate(string.Format(promptMsg, $"[green][underline]{promptArg}[/][/]"));
    }
}